...
runName <- "siteoccupancy-sources-yearlyP"
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Grafik mit Vergleich der Trends von einer Art machen ----
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

s <- 10
resultate %>% 
  filter(NUESP == species$NUESP[s]) %>% 
  filter(runID %in% c("BDM-only", "infospecies-raw-occupancy-reportingtyp", "siteoccupancy-sources", "siteoccupancy-sources-yearlyP")) %>%
